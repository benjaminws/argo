...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkflowSteps) DeepCopyInto(out *WorkflowSteps) {
	*out = *in
	if in.Steps != nil {
		in, out := &in.Steps, &out.Steps
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkflowSteps.
func (in *WorkflowSteps) DeepCopy() *WorkflowSteps {
	if in == nil {
		return nil
	}
	out := new(WorkflowSteps)
	in.DeepCopyInto(out)
	return out
}
